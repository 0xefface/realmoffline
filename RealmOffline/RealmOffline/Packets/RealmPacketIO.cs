...
namespace RealmOffline.Packets
{
    public class RealmPacketIO
    {
        ...
        {
            Console.WriteLine("Router wants reply to packet id {0}", pid);
            switch (pid)
            {
                case 6:
                    {
                        ...
                        // genrally 2 packets with id of 4 preceeds this when encyption is active.
                        byte[] hello = new byte[]
                        {
